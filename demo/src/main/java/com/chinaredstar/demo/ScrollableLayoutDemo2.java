...
public class ScrollableLayoutDemo2 extends BaseActivity {
    ...
    protected void initWidget() {
        ...
        ptr_view.setPtrHandler(new PtrHandler() {
            ...
            public void onRefreshBegin(PtrFrameLayout frame) {
                count = 0;
                sl_root.requestScrollableLayoutDisallowInterceptTouchEvent(false);
                JHandler.handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        sl_root.requestScrollableLayoutDisallowInterceptTouchEvent(true);
